        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-start">
                ...
                return (
                  <div
                    ...
                    className={`px-4 py-3 rounded-xl border transition-all duration-300 cursor-pointer flex items-center justify-between group ${
                      isSelected
                        ? 'bg-white text-[#3D352D] border-[#C96F1B] shadow-lg translate-x-1'
            ...
            <div className="lg:col-span-8 bg-white p-5 sm:p-7 rounded-2xl border border-[#E8DDD0] shadow-xl space-y-4">
              ...
              {/* Unique Image Stage */}
              <div
                className="relative rounded-xl overflow-hidden bg-[#F5EEE5] group h-[220px] sm:h-[280px] lg:h-[320px]"
              >
                <img
                ...
                <div className="pt-3 border-t border-[#E8DDD0] flex flex-wrap items-center gap-3">
                  {activeIndustry.relatedServiceLinks.map((lnk, lIdx) => (
                    <Link
                      key={lIdx}
                      to={lnk.href}
                      className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-white hover:bg-[#EADBC8] text-[#3D352D] border border-[#E8DDD0] font-specs font-bold text-[11px] uppercase tracking-wider transition-colors"
                    >
                      <span>{lnk.name}</span>
