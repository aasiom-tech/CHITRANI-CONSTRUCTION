...
export const IndustryCTA: React.FC = () => {
  return (
    <div className="bg-[#3D352D] rounded-[18px] p-8 sm:p-12 text-white text-center space-y-6 shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <Link
          to="/services"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg bg-[#F5EEE5] hover:bg-[#EADBC8] text-[#3D352D] font-heading text-xs font-bold uppercase tracking-wider transition-all border border-[#E8DDD0]"
        >
