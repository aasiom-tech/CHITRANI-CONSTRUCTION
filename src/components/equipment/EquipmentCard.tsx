    ...
    <div className="bg-white rounded-[18px] border border-[#E8DDD0] shadow-[0_10px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] hover:border-[#C96F1B] motion-safe:hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between overflow-hidden group">
      <div>
        ...
        <div className="relative aspect-[16/9] overflow-hidden bg-[#F5EEE5]">
          ...
          />
          <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-xs px-3 py-1.5 rounded-full border border-[#E8DDD0] text-[11px] font-heading font-semibold text-[#3D352D] flex items-center gap-1.5 uppercase tracking-wider shadow-xs">
        ...
        <div className="p-6 sm:p-8 space-y-5">
          ...
          <div className="pt-4 border-t border-[#E8DDD0] space-y-3">
            <h4 className="font-heading text-xs text-[#3D352D] font-semibold uppercase tracking-wider">
