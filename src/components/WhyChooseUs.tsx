        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {points.map((pt, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-white p-7 rounded-[18px] border border-[#E8DDD0] border-t-2 border-t-[#C96F1B] shadow-[0_10px_30px_rgba(61,53,45,0.04)] hover:-translate-y-1 hover:shadow-[0_16px_38px_rgba(61,53,45,0.09)] transition-all duration-300 space-y-4 group flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="w-12 h-12 rounded-full bg-[#F5EEE5] border border-[#E8DDD0] text-[#C96F1B] flex items-center justify-center transition-colors">
